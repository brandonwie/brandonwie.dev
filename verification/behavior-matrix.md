...
| -------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------- |
| The tab never becomes visible                | `document.visibilityState === "hidden"` on every tab, including a freshly created one                                         | No paint, so no FCP/LCP, no `requestAnimationFrame`          | Paint-dependent metrics are **not** reported; see `thresholds-results.md`                                                       |
...
after a forced paint the deck animates and renders normally.
