<script lang="ts">
	import AvlTreeVisualizer from '$lib/components/study/AvlTreeVisualizer.svelte';
	import TwoFourTreeVisualizer from '$lib/components/study/TwoFourTreeVisualizer.svelte';
	import IterativeSortVisualizer from '$lib/components/study/IterativeSortVisualizer.svelte';
	import DivideConquerSortVisualizer from '$lib/components/study/DivideConquerSortVisualizer.svelte';
	...
	import { getDsaIIIContent, type StudyLocale } from '$lib/data/study';

	let { locale = 'en' }: { locale?: StudyLocale } = $props();

	const content = $derived(getDsaIIIContent(locale));
